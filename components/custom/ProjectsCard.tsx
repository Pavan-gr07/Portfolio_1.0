...
export default function ProjectsCard({
  ...
  return (
    <div
      className="max-w-sm bg-black-400 dark:bg-black-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-black-200 dark:border-black-700"
      {...props}
    >
